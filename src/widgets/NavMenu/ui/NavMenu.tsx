...
import { classNames } from '../../../../../dmz.name/src/shared/lib/classNames/classNames';
import cls from './NavMenu.module.scss';
import { createPortal } from 'react-dom';
import { useVisible } from '../../../../../dmz.name/src/app/providers/VisibleProvider';
	...
	return isShow
		? createPortal(
				<nav className={classNames(cls.root, {}, [className])}>
					...
					>
						<li className={cls['nav-link']}>{t('Прайс')}</li>
